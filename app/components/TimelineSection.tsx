    ...
    <div className="max-w-4xl w-full mx-auto centered">
      <div className="my-6 relative">
        {items.map((item, index) => (
          <div key={index} className="relative pl-8 sm:pl-32 py-8 group">
            ...
            <div
              ...
              after:absolute after:left-2 sm:after:left-0 after:w-2 after:h-2 after:bg-indigo-600 after:border-4
              after:box-content after:border-slate-50 after:rounded-full sm:after:ml-[6.5rem]
            ...
            {/* 👇 Change here: render list if array, paragraph if string */}
